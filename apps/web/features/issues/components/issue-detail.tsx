          ...
          {childIssues.length > 0 && (
            <div className="mt-8">
              <div className="flex items-center gap-3 mb-1">
                ...
                <span className="text-xs text-muted-foreground">{childIssues.filter((c) => c.status === "done").length}/{childIssues.length}</span>
                <button
                  type="button"
              ...
              <div className="ml-5 border-l">
                {childIssues.map((child) => (
                  <Link
                    ...
                    className="flex items-center gap-3 pl-4 pr-2 py-2.5 hover:bg-accent/40 transition-colors group"
                  >
